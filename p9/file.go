...
type File interface {
	...
	// attributes.
	//
	// Server-side p9.Files may return errors.ENOSYS to indicate that Walk
	...
	//
	// This may return io.EOF in addition to errors.Errno values.
	//
...
func (DefaultWalkGetAttr) WalkGetAttr([]string) ([]QID, File, AttrMask, Attr, error) {
	return nil, nil, AttrMask{}, Attr{}, errors.ENOSYS
}
